...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::middleware(['checkRole:admin,karyawan'])->group(function () {
        ...
        Route::post('/databarang/create', [MengelolahDataObatController::class, 'store'])->name('mengolahdataobat.store');
        ...
        Route::post('/databarang/kategori/create', [MengelolahDataObatController::class, 'indexkategoristore'])->name('mengolahdataobat.indexkategoristore');
        ...
        //Akunting
        Route::get('/akunting/inputmodal', [AkuntingController::class, 'inputModalAwal']);
        Route::post('/akunting/inputmodal', [AkuntingController::class, 'modalAwalStore'])->name('akunting.modalAwalStore');
        Route::get('/akunting/persediaan', [AkuntingController::class, 'persediaanAkhirBulan']);
        Route::get('/akunting/jurnalumum', [AkuntingController::class, 'jurnalUmum']);
        Route::get('/akunting/jurnalumum/create', [AkuntingController::class, 'jurnalUmumCreate']);
        Route::post('/akunting/jurnalumum/create', [AkuntingController::class, 'jurnalUmumStore'])->name('akunting.jurnalUmumStore');
        Route::delete('/akunting/jurnalumum/{id}', [AkuntingController::class, 'jurnalUmumDestroy'])->name('akunting.jurnalUmumDestroy');
        Route::get('/akunting/bukubesar', [AkuntingController::class, 'bukuBesar']);
        Route::get('/akunting/laporan', [AkuntingController::class, 'laporanRugiLaba']);
        Route::get('/akunting/neraca', [AkuntingController::class, 'neraca']);
        Route::get('/akunting/neraca/coba', [AkuntingController::class, 'neracaCoba']);
