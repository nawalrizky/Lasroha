...
<div class="container-fluid p-0">
    ...
    <form action="{{ route('mengolahdataobat.indexkategoristore') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="form-row">
            <div class="form-group col-md-6">
                <label for="name" class="col-form-label"><strong>Kategori Barang :</strong></label>
